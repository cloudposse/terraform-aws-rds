...
| license\_model | License model for this DB. Optional, but required for some DB Engines. Valid values: `license-included`, `bring-your-own-license`, or `general-public-license` | `string` | `""` | no |
